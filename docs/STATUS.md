...
- Legibilidade: 82 classes e 398 membros mapeados possuem nomes validos ou
...
- Proxima fase: nomear a montagem inicial de elenco, configuracoes taticas,
  vinculo de jogador e renovacao usadas pelo mercado.
