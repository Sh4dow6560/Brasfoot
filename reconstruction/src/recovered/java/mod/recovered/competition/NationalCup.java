...
public class NationalCup extends Competition implements Serializable {
   ...
   public NationalCup(CountryCompetitions c0692) {
      this.KR = c0692;
      this.F(2, c0692.gg());
   ...
   public void a(NationalCup c0942, ArrayList arrayList, boolean[] bls) {
   ...
   public void b(NationalCup c0942, ArrayList arrayList, boolean[] bls) {
