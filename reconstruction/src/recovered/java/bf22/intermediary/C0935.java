...
public class C0935 extends C0713 implements Serializable {
   private static final long serialVersionUID = 1L;
   private C0955 agp = null;
   private C0955 agq = null;
   private C0955 agr = null;
   private C0955 ags = null;
   ...
   public void Ar() {
      if (this.YH == 0) {
         ...
         for (int var5 = 0; var5 < var1.length; var5++) {
            this.agt.add(C0745.SR.s(var1[var5]).jo());
         }

         for (int var6 = 0; var6 < var2.length; var6++) {
            this.agu.add(C0745.SR.s(var2[var6]).jo());
         }

         for (int var7 = 0; var7 < var3.length; var7++) {
            this.agv.add(C0745.SR.s(var3[var7]).jo());
         }

         for (int var8 = 0; var8 < var4.length; var8++) {
            this.agw.add(C0745.SR.s(var4[var8]).jo());
         }
      }
      ...
      this.agy = -1;
      this.YH++;
      C0745.afQ.L(this.agt);
      C0745.afQ.L(this.agu);
      C0745.afQ.L(this.agv);
      C0745.afQ.L(this.agw);
   }

   private C0955 e(ArrayList arrayList, int i) {
      if (arrayList.size() != 16 && arrayList.size() != 7) {
         return null;
      }

      for (int var3 = 0; var3 < arrayList.size(); var3++) {
         C0745.SR.s(((Club)arrayList.get(var3)).getPais()).z(false);
      }
      ...
      C0955 var5 = new C0955(var4, arrayList, 0, null, null, null, 14, null, false, null, true, this);
      var5.fb(i);
   ...
   public void yt() {
      ...
      this.afT = new C0962(null, var1.size(), this.b(), 0, var2, this, -1);
   ...
   public void BB() {
      ...
      this.agx = new C0962(null, var1.size(), this.b(), 1, var2, this, 14006);
      C0929 var3 = new C0929();
   ...
   @Override
   public C0678[] mB() {
      C0678[] var1 = new C0678[]{this.agp};
      if (this.afT != null) {
         C0678[] var2 = new C0678[]{this.afT};
         var1 = var2;
      }
   ...
   public ArrayList mC() {
      ArrayList var1 = new ArrayList();
      C0678[] var2 = new C0678[]{this.agp};
      var1.add(new C0830(var2, "Liga A"));
      C0678[] var3 = new C0678[]{this.agq};
      var1.add(new C0830(var3, "Liga B"));
      C0678[] var4 = new C0678[]{this.agr};
      var1.add(new C0830(var4, "Liga C"));
      C0678[] var5 = new C0678[]{this.ags};
      var1.add(new C0830(var5, "Liga D"));
      C0678[] var6 = new C0678[]{this.afT};
      var1.add(new C0830(var6, "Fase Final"));
      C0678[] var7 = new C0678[]{this.agx};
   ...
   public String[] b(C0678 c0678) {
      return c0678 == this.agx ? C0710.abX : C0710.pF;
   }
