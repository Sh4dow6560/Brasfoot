   ...
   public String ck() {
      ...
      if (var1 == null) {
         for (int var3 = 0; var3 < GamePersistence.careerState.aG().size(); var3++) {
            if (((CountryCompetitions)GamePersistence.careerState.aG().get(var3)).jn() != null && ((CountryCompetitions)GamePersistence.careerState.aG().get(var3)).jn().getClubId() == this.bW) {
