...
public class C0730 {
      ...
      if (j == 0) {
         ...
         if (this.cq == 0 || var7) {
            for (int var8 = 0; var8 < C0745.SR.N().size(); var8++) {
               if (((C0692)C0745.SR.N().get(var8)).gg() == 0 && !this.cn.contains(C0745.SR.N().get(var8))) {
                  this.cn.add((C0692)C0745.SR.N().get(var8));
               }
            }
         }

         for (int var11 = 0; var11 < C0745.SR.N().size(); var11++) {
            if (((C0692)C0745.SR.N().get(var11)).gg() == 0 && !this.cn.contains(C0745.SR.N().get(var11))) {
               this.co.add((C0692)C0745.SR.N().get(var11));
            }
         }

         for (int var12 = 0; var12 < C0745.SR.N().size(); var12++) {
            if (((C0692)C0745.SR.N().get(var12)).gg() == 0) {
               this.cp.add((C0692)C0745.SR.N().get(var12));
            }
         }
      } else if (j == 1) {
         if (this.ck != null && this.ck.kn()) {
         ...
         if (this.cq == 0 || var9) {
            for (int var13 = 0; var13 < C0745.SR.N().size(); var13++) {
               if (((C0692)C0745.SR.N().get(var13)).gg() == 0 && !this.cn.contains(C0745.SR.N().get(var13))) {
                  this.cn.add((C0692)C0745.SR.N().get(var13));
               }
            }
         }

         if (this.cq == 1) {
            for (int var14 = 0; var14 < C0745.SR.N().size(); var14++) {
               if (((C0692)C0745.SR.N().get(var14)).gg() != 5 && !this.cn.contains(C0745.SR.N().get(var14))) {
                  this.cn.add((C0692)C0745.SR.N().get(var14));
               }
            }
         }

         if (this.cq == 2) {
            for (int var15 = 0; var15 < C0745.SR.N().size(); var15++) {
               if ((((C0692)C0745.SR.N().get(var15)).gg() == 0 || ((C0692)C0745.SR.N().get(var15)).gg() == 3) && !this.cn.contains(C0745.SR.N().get(var15))) {
                  this.cn.add((C0692)C0745.SR.N().get(var15));
               }
            }
         }

         if (this.cq == 3) {
            for (int var16 = 0; var16 < C0745.SR.N().size(); var16++) {
               if ((((C0692)C0745.SR.N().get(var16)).gg() == 3 || ((C0692)C0745.SR.N().get(var16)).gg() == 0) && !this.cn.contains(C0745.SR.N().get(var16))) {
                  this.cn.add((C0692)C0745.SR.N().get(var16));
               }
            }
         }
         ...
         if (this.ck.getPais() != 131 && this.ck.getPais() != 68) {
            if (this.cq == 4) {
               for (int var18 = 0; var18 < C0745.SR.N().size(); var18++) {
                  if (((C0692)C0745.SR.N().get(var18)).gg() == 4 && !this.cn.contains(C0745.SR.N().get(var18))) {
                     this.cn.add((C0692)C0745.SR.N().get(var18));
                  }
               }
            }
         } else {
            for (int var17 = 0; var17 < C0745.SR.N().size(); var17++) {
               if (((C0692)C0745.SR.N().get(var17)).gg() == 0 && !this.cn.contains(C0745.SR.N().get(var17))) {
                  this.cn.add((C0692)C0745.SR.N().get(var17));
               }
            }
         }

         if (this.cq == 5) {
            for (int var19 = 0; var19 < C0745.SR.N().size(); var19++) {
               if ((((C0692)C0745.SR.N().get(var19)).gg() == 5 || ((C0692)C0745.SR.N().get(var19)).gg() == 3) && !this.cn.contains(C0745.SR.N().get(var19))) {
                  this.cn.add((C0692)C0745.SR.N().get(var19));
               }
            }
         }

         for (int var20 = 0; var20 < C0745.SR.N().size(); var20++) {
            if (((C0692)C0745.SR.N().get(var20)).gg() == 0 && !this.cn.contains(C0745.SR.N().get(var20))) {
               this.co.add((C0692)C0745.SR.N().get(var20));
            }
         }

         for (int var21 = 0; var21 < C0745.SR.N().size(); var21++) {
            if (((C0692)C0745.SR.N().get(var21)).gg() == 0) {
               this.cp.add((C0692)C0745.SR.N().get(var21));
            }
         }
      } else if (j == 2) {
         for (int var10 = 0; var10 < C0745.SR.N().size(); var10++) {
            if (((C0692)C0745.SR.N().get(var10)).gg() == 0 && !this.cn.contains(C0745.SR.N().get(var10))) {
               this.cn.add((C0692)C0745.SR.N().get(var10));
            }
         }
      }
   }
   ...
   public Club a(boolean bl, boolean bl2) {
      ...
      if (this.cl == null && C0745.SR.H() > 2 && this.cj && this.ci < this.U.fk()) {
         var3 = this.cJ();
      }
   ...
   private Club cH() {
      ...
      for (int var3 = 0; var3 < C0745.SR.P().size(); var3++) {
         if (!((Club)C0745.SR.P().get(var3)).kn()
            && C0745.SR.P().get(var3) != this.U.fg()
            && !((Club)C0745.SR.P().get(var3)).jZ()
            && ((Club)C0745.SR.P().get(var3)).kc().size() < this.cx
            && ((Club)C0745.SR.P().get(var3)).lk() != this.U.fA()) {
            var2.add((Club)C0745.SR.P().get(var3));
         }
      }
   ...
   private Club cI() {
      ...
      for (int var3 = 0; var3 < C0745.SR.P().size(); var3++) {
         if (((Club)C0745.SR.P().get(var3)).getReputacao() >= 4
            && C0745.SR.P().get(var3) != this.U.fg()
            && !((Club)C0745.SR.P().get(var3)).jZ()
            && ((Club)C0745.SR.P().get(var3)).kc().size() < this.cx
            && ((Club)C0745.SR.P().get(var3)).lk() != this.U.fA()) {
   ...
   private Club cJ() {
      ...
      for (int var3 = 0; var3 < C0745.SR.P().size(); var3++) {
         if (C0745.SR.P().get(var3) != this.U.fg()
            && !((Club)C0745.SR.P().get(var3)).jZ()
            && ((Club)C0745.SR.P().get(var3)).kc().size() < 35
            && ((Club)C0745.SR.P().get(var3)).lk() != this.U.fA()) {
            var2.add((Club)C0745.SR.P().get(var3));
         }
      }
   ...
   private Club a(ArrayList arrayList, boolean bl) {
      ...
      for (int var7 = 0; var7 < arrayList.size(); var7++) {
         if (this.U.fi() <= 5) {
            var4 = 0;
            var5 = ((C0692)arrayList.get(var7)).js();
         ...
         if (this.cs == 0) {
            for (int var8 = 0; var8 < ((C0692)arrayList.get(var7)).jg().size(); var8++) {
               if (((C0692)arrayList.get(var7)).jg().get(var8) != this.U.fg()
                  && ((Club)((C0692)arrayList.get(var7)).jg().get(var8)).getDivisao() <= var5
                  && ((Club)((C0692)arrayList.get(var7)).jg().get(var8)).lk() != this.U.fA()
                  && ((Club)((C0692)arrayList.get(var7)).jg().get(var8)).getDivisao() >= var4
                  && ((C0692)arrayList.get(var7)).jg().get(var8) != this.ck
                  && !((Club)((C0692)arrayList.get(var7)).jg().get(var8)).jZ()
                  && ((Club)((C0692)arrayList.get(var7)).jg().get(var8)).kc().size() < this.cx) {
                  int[] var9 = ((Club)((C0692)arrayList.get(var7)).jg().get(var8)).J(true);
                  var3.add((Club)((C0692)arrayList.get(var7)).jg().get(var8));
               }
            }
         } else {
            for (int var11 = 0; var11 < ((C0692)arrayList.get(var7)).jg().size(); var11++) {
               if (((C0692)arrayList.get(var7)).jg().get(var11) != this.U.fg()
                  && ((Club)((C0692)arrayList.get(var7)).jg().get(var11)).getDivisao() <= var5
                  && ((Club)((C0692)arrayList.get(var7)).jg().get(var11)).lk() != this.U.fA()
                  && ((Club)((C0692)arrayList.get(var7)).jg().get(var11)).getDivisao() >= var4
                  && ((C0692)arrayList.get(var7)).jg().get(var11) != this.ck
                  && !((Club)((C0692)arrayList.get(var7)).jg().get(var11)).jZ()
                  && ((Club)((C0692)arrayList.get(var7)).jg().get(var11)).kc().size() < this.cx) {
                  int[] var13 = ((Club)((C0692)arrayList.get(var7)).jg().get(var11)).J(true);
                  var3.add((Club)((C0692)arrayList.get(var7)).jg().get(var11));
               }
            }
         }
      }
   ...
   public static int a(Player player, Club club) {
      if (player != null && club != null) {
         ...
         for (int var4 = 0; var4 < C0745.SR.bt().size(); var4++) {
            if (((C0825)C0745.SR.bt().get(var4)).x().fg() != null && ((C0825)C0745.SR.bt().get(var4)).x().fg() == club) {
               var3++;
            }
         }
   ...
   public static void a(Club club, int[] is) {
      ...
      if (club.kn()) {
         ...
         for (int var13 = 0; var13 < C0745.SR.P().size(); var13++) {
            if (!((Club)C0745.SR.P().get(var13)).jZ()
               && C0745.SR.P().get(var13) != club
               && ((Club)C0745.SR.P().get(var13)).gg() == club.gg()
               && var3 <= ((Club)C0745.SR.P().get(var13)).getReputacao()
               && var4 >= ((Club)C0745.SR.P().get(var13)).getReputacao()) {
               var7.add((Club)C0745.SR.P().get(var13));
            }
         }
