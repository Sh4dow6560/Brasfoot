...
public class C0960 extends C0713 implements Serializable {
   ...
   public void yq() {
      ...
      var2.addAll(C0745.SR.aI().yy());
      var2.addAll(C0745.SR.aI().yE());
      if (C0745.SR.H() > 1 && this.ago != null && !C0745.SR.aI().yy().contains(this.ago) && !C0745.SR.aI().yE().contains(this.ago)) {
   ...
   public void aj(ArrayList arrayList) {
      ...
      this.YP = new C0962(null, var4.size(), this.b(), 1, var9, this, 6001);
   ...
   public void g(ArrayList arrayList, ArrayList arrayList2) {
      ...
      this.YQ = new C0962(null, var6.size(), this.b(), 1, var18, this, 6002);
   ...
   public void m(ArrayList arrayList, ArrayList arrayList2) {
      ...
      if (var20.size() == 32) {
         ...
         C0955 var12 = new C0955(var11, var20, 0, null, null, null, 6, null, false, null, true, this);
         var12.fb(6005);
         this.YD = var12;
   ...
   public void Be() {
      ...
      for (int var7 = 0; var7 < C0745.SR.aI().yd().yQ().size(); var7++) {
         var2.add((Club)((C0673)C0745.SR.aI().yd().yQ().get(var7)).gR().get(2));
      }
      ...
      this.YD.c(new C0962(this.YD, var3.size(), this.b(), 1, var11, this, 6006));
      C0929 var6 = new C0929();
   ...
   public C0678[] mB() {
      ...
      if (this.YD == null) {
         C0678[] var2 = new C0678[]{this.YP, this.YQ};
         var1 = var2;
